...
public class SpecialHouses {
    ...
    static {
        RULES.put(15, "isStartSquare: يُعاد إرسال الأحجار إلى هذا المربع من أجل «البعث». وإذا كان مشغولًا، يُنقل الحجر إلى أول مربع غير مشغول يسبقه.");
        RULES.put(26, "isBarrierSquare: يجب على جميع الأحجار المرور عبر هذا المربع. ولا يُسمح بالقفز فوقه، بل يجب الهبوط عليه مباشرة.");
        RULES.put(27, "isReturnSquare: إذا هبط حجر على هذا المربع، فعليه العودة فورًا إلى بيت البعث.");
        RULES.put(28, "isThreeSquare: إذا هبط حجر على هذا المربع، فإنه يمكن في الدور التالي خروج هذا الحجر إذا حصل اللاعب على رمية مقدارها 3.");
        RULES.put(29, "isTwoSquare: إذا هبط حجر على هذا المربع، فإنه يمكن في الدور التالي خروج هذا الحجر إذا حصل اللاعب على رمية مقدارها 2.");
